...
<div id="logo-box">
<!-- The Logo and the Top Bar Stays Here -->
...
<div id="slider" class="nivoSlider"><!--Slideshow Placement-->
<img src="<?php echo $OUTPUT->pix_url('slide', 'theme'); ?>" width="800" />
<img src="<?php echo $OUTPUT->pix_url('slider2', 'theme'); ?>" width="800" /> 
<img src="<?php echo $OUTPUT->pix_url('slider3', 'theme'); ?>" width="800" />
</div></div><!--Slideshow Placement-->
